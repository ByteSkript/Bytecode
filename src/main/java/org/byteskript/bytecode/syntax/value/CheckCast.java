...
public class CheckCast extends Effect {
    
    public CheckCast() {
        super(Bytecode.LIBRARY, StandardElements.EFFECT, "checkcast %Type%");
    }
    
    @Override
    public Pattern.Match match(String thing, Context context) {
        if (!thing.startsWith("checkcast ")) return null;
    ...
    public void compile(Context context, Pattern.Match match) {
        ...
        assert method != null;
        method.writeCode((writer, visitor) -> visitor.visitTypeInsn(192, owner.internalName()));
