...
public class IfSimple extends Effect {
    
    public IfSimple() {
        super(Bytecode.LIBRARY, StandardElements.EFFECT, "ifeq %Label%", "ifne %Label%", "iflt %Label%", "ifge %Label%", "ifgt %Label%", "ifle %Label%");
    }
    ...
    public void compile(Context context, Pattern.Match match) {
        ...
        assert method != null;
        final int opcode = match.matchedPattern + 153;
        assert opcode >= 153 && opcode <= 158;
